...
const ResumeAnalysisCard = () => {
    ...
    return (
        <div className="bg-[#1A1A1A] border border-[#21c768] rounded-2xl p-8 h-4xl flex flex-col justify-between">
            ...
            <button onClick={handleResumeUpload} className="mt-10 flex items-center gap-2 bg-[#B8B5FF] text-black px-6 py-3 rounded-lg w-fit font-medium hover:opacity-80">
                Resume Upload
                <ArrowRight size={18} />
            </button>
        </div>
